...
public interface ITrackingSessionService
{
    ...
    /// <summary>
    /// Get peak hours data grouped by area/building/floor/floorplan
    /// Returns hourly distribution of visitors across different entities
    /// </summary>
    Task<PeakHoursByAreaRead> GetPeakHoursByAreaAsync(
