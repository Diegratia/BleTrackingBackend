    ...
    public class BoundaryController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAll()
        {
            try
            {
                ...
                {
                    success = true,
                    msg = "Boundarys retrieved successfully",
        ...
        public async Task<IActionResult> GetById(Guid id)
        {
            try
            {
                ...
                {
                    success = true,
                    msg = "Boundary retrieved successfully",
        ...
        public async Task<IActionResult> Create([FromBody] BoundaryCreateDto dto)
        {
            ...
            try
            {
                ...
                {
                    success = true,
                    msg = "Boundary created successfully",
        ...
        public async Task<IActionResult> Update(Guid id, [FromBody] BoundaryUpdateDto dto)
        {
            ...
            try
            {
                ...
                {
                    success = true,
                    msg = "Boundary updated successfully",
                    collection = new { data = (object)null },
                    code = 204
                });
            }
        ...
        public async Task<IActionResult> Delete(Guid id)
        {
            try
            {
                ...
                {
                    success = true,
                    msg = "Boundary deleted successfully",
                    collection = new { data = (object)null },
                    code = 204
                });
            }
        ...
        public async Task<IActionResult> Filter([FromBody] DataTablesRequest request)
        {
            ...
            try
            {
                ...
                {
                    success = true,
                    msg = "Boundary filtered successfully",
                    collection = result,
                    code = 200
                });
            }
