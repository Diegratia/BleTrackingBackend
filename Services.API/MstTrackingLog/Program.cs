...
builder.Services.AddAutoMapper(typeof(MstTrackingLogProfile));

builder.Services.AddScoped<IMstTrackingLogService, MstTrackingLogService>();


// builder.Services.AddScoped<IMstApplicationService, MstApplicationService>();

builder.Services.AddScoped<MstTrackingLogRepository>();



var port = Environment.GetEnvironmentVariable("MST_TRACKING_LOG_PORT") ??
           builder.Configuration["Ports:MstTrackinglog"];
