...
// builder.Services.AddAutoMapper(typeof(ExtAlarmProfile));
// Registrasi Services
builder.Services.AddScoped<IExtAlarmService, ExtAlarmService>();
// builder.Services.AddScoped<ITrxVisitorService, TrxVisitorService>();
// builder.Services.AddScoped<ICardService, CardService>();

// Registrasi Repositories
// builder.Services.AddScoped<ExtAlarmPRepository>();
