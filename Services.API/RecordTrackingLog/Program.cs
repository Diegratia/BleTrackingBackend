...
builder.Services.AddAutoMapper(typeof(RecordTrackingLogProfile));

builder.Services.AddScoped<IRecordTrackingLogService, RecordTrackingLogService>();


// builder.Services.AddScoped<IMstApplicationService, MstApplicationService>();

builder.Services.AddScoped<RecordTrackingLogRepository>();



var port = Environment.GetEnvironmentVariable("RECORD_TRACKING_LOG_PORT") ??
           builder.Configuration["Ports:RecordTrackingLog"];
